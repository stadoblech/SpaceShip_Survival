...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/chunk.png", __ASSET__assets_images_chunk_png);
		type.set ("assets/images/chunk.png", AssetType.IMAGE);
		...
		className.set ("assets/music/nebula.wav", __ASSET__assets_music_nebula_wav);
		type.set ("assets/music/nebula.wav", AssetType.SOUND);
...
@:keep class __ASSET__assets_images_chunk_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep class __ASSET__assets_images_trash_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_music_music_goes_here_txt extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_music_nebula_wav extends openfl.media.Sound { }
...
@:bitmap("assets/images/chunk.png") class __ASSET__assets_images_chunk_png extends flash.display.BitmapData {}
...
@:bitmap("assets/images/Trash.png") class __ASSET__assets_images_trash_png extends flash.display.BitmapData {}
@:file("assets/music/music-goes-here.txt") class __ASSET__assets_music_music_goes_here_txt extends flash.utils.ByteArray {}
@:sound("assets/music/nebula.wav") class __ASSET__assets_music_nebula_wav extends flash.media.Sound {}
